...
- **生成 AI**
  ...
  - [金融ワークロードアーキテクチャ解説 [生成 AI]
    ](doc/reference-arc-genai/genai-arch-readme.md)
  - [FISC 実務基準対策 一覧 [生成 AI]
    ](doc/reference-arc-genai/fisc-mapping-genai.md)
  - [CDK サンプルコード [生成 AI]
    ](doc/reference-arc-genai/deploy-genai-sample.md)
...
| [生成 AI] サンプルアプリケーション                    | N/A （詳細は[CDK サンプルコード [生成 AI]](doc/reference-arc-genai/deploy-genai-sample.md)参照） |
...
- [9. [生成 AI] サンプルアプリケーションのセットアップ手順](doc/reference-arc-genai/deploy-genai-sample.md)
...
AWS サービスの活用方法について金融業界における具体的なユースケースに照らして情報提供します。

- [1. 金融業界での生成 AI ユースケース](doc/fsi-case-study/reference-arc-genai-usecase/README.md)
