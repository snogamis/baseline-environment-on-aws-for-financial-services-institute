...
/*
 * Aurora Global DBの作成（Primary Region）
 */

export interface DbAuroraPgGlobalPrimaryProps {
  myVpc: ec2.Vpc;
  dbName: string;
  dbUser: string;
...
export class DbAuroraPgGlobalPrimary extends Construct implements IAuroraGlobalCluster {
